...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        if not db_table_field_exists("rapidsms_xforms_xformfield","question"):
            db.add_column('rapidsms_xforms_xformfield', 'question',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rapidsms_xforms_xformfield', 'question')
