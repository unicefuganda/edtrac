...
urlpatterns = patterns('',
    ...
    url(r"^(\d+)/responses/module/$", views.view_responses,  {'as_module':True}, name="poll-responses-module"),    
    ...
    url(r"^(\d+)/report/module/$", views.view_report, {'as_module':True}, name="poll-report-module"),
