...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EnrolledDeployedQuestionsAnswered'
        db.create_table('education_enrolleddeployedquestionsanswered', (
        ...
        db.send_create_signal('education', ['EnrolledDeployedQuestionsAnswered'])


    def backwards(self, orm):
        
        # Deleting model 'EnrolledDeployedQuestionsAnswered'
        db.delete_table('education_enrolleddeployedquestionsanswered')
