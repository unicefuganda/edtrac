...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XFormSubmission.approved'
        db.add_column('rapidsms_xforms_xformsubmission', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'XFormSubmission.approved'
        db.delete_column('rapidsms_xforms_xformsubmission', 'approved')
