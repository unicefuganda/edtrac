...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contact_masstext', (
        ...
        db.send_create_signal('contact', ['MassText'])

        # Adding M2M table for field sites on 'MassText'
        db.create_table('contact_masstext_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masstext', models.ForeignKey(orm['contact.masstext'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('contact_masstext_sites', ['masstext_id', 'site_id'])

        # Adding M2M table for field contacts on 'MassText'
        db.create_table('contact_masstext_contacts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masstext', models.ForeignKey(orm['contact.masstext'], null=False)),
            ('contact', models.ForeignKey(orm['rapidsms.contact'], null=False))
        ))
        db.create_unique('contact_masstext_contacts', ['masstext_id', 'contact_id'])

        # Adding model 'Flag'
        db.create_table('contact_flag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('contact', ['Flag'])

        # Adding model 'MessageFlag'
        db.create_table('contact_messageflag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flags', to=orm['rapidsms_httprouter.Message'])),
            ('flag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', null=True, to=orm['contact.Flag'])),
        ))
        db.send_create_signal('contact', ['MessageFlag'])


    def backwards(self, orm):
        
        # Deleting model 'MassText'
        db.delete_table('contact_masstext')

        # Removing M2M table for field sites on 'MassText'
        db.delete_table('contact_masstext_sites')

        # Removing M2M table for field contacts on 'MassText'
        db.delete_table('contact_masstext_contacts')

        # Deleting model 'Flag'
        db.delete_table('contact_flag')

        # Deleting model 'MessageFlag'
        db.delete_table('contact_messageflag')
