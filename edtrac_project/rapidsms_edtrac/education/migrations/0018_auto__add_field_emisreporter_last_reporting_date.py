...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmisReporter.last_reporting_date'
        db.add_column('education_emisreporter', 'last_reporting_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmisReporter.last_reporting_date'
        db.delete_column('education_emisreporter', 'last_reporting_date')
    ...
    models = {
        ...
        'education.emisreporter': {
            ...
            'last_reporting_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        'education.term': {
            ...
            'term': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
