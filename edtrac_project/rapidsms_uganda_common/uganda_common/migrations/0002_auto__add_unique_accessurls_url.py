...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AccessUrls', fields ['url']
        db.create_unique('uganda_common_accessurls', ['url'])

        # Adding M2M table for field allowed_locations on 'Access'
        db.create_table('uganda_common_access_allowed_locations', (
        ...
        db.create_unique('uganda_common_access_allowed_locations', ['access_id', 'location_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AccessUrls', fields ['url']
        db.delete_unique('uganda_common_accessurls', ['url'])

        # Removing M2M table for field allowed_locations on 'Access'
        db.delete_table('uganda_common_access_allowed_locations')
