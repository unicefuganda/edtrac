...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Term'
        db.create_table('education_term', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(default=2013)),
            ('term', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('education', ['Term'])


    def backwards(self, orm):
        # Deleting model 'Term'
        db.delete_table('education_term')
