...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PollSchedule'
        db.delete_table('education_pollschedule')

        # Adding model 'ScriptSchedule'
        db.create_table('education_scriptschedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('script', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['script.Script'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('education', ['ScriptSchedule'])


    def backwards(self, orm):
        
        # Adding model 'PollSchedule'
        db.create_table('education_pollschedule', (
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poll.Poll'])),
        ))
        db.send_create_signal('education', ['PollSchedule'])

        # Deleting model 'ScriptSchedule'
        db.delete_table('education_scriptschedule')
    ...
    models = {
        ...
        'education.role': {
            'Meta': {'object_name': 'Role', 'db_table': "'auth_group'", '_ormbases': ['auth.Group'], 'proxy': 'True'}
        },
        'education.school': {
