...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScriptProgress.language'
        db.add_column('script_scriptprogress', 'language', self.gf('django.db.models.fields.CharField')(max_length=5, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScriptProgress.language'
        db.delete_column('script_scriptprogress', 'language')
