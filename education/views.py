...
def female_teacher_attendance(req):
    ...
    data_to_render = []
    for school in schools:
        data = get_sum_of_poll_response(Poll.objects.get(name="edtrac_f_teacher_attendance"),month_filter='weekly',location=school.location)
        data_to_render.append(
            [
                school,
                school.location,
...
def male_teacher_attendance(req):
    ...
    data_to_render = []
    for school in schools:
        data = get_sum_of_poll_response(Poll.objects.get(name="edtrac_m_teacher_attendance"),month_filter='weekly',location=school.location)
        data_to_render.append(
            [
                school,
                school.location,
