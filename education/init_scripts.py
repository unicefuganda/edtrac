...
def init_scripts():
    simple_scripts = {
        ...
        'teachers monthly':[(Poll.TYPE_TEXT, 'emis_p3curriculum_progress', 'What is the progress of the P3 school curriculum this week?',),
                            (Poll.TYPE_TEXT, 'emis_p6curriculum_progress', 'What is the progress of the P6 school curriculum this week?',),
                           ],
