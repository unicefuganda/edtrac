...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('education_userprofile', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.user'
        db.delete_column('education_userprofile', 'user_id')
