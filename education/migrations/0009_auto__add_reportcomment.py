...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('education_reportcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('commentable', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('reporting_period', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('report_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('education', ['ReportComment'])


    def backwards(self, orm):
        
        # Deleting model 'ReportComment'
        db.delete_table('education_reportcomment')
