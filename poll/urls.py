...
urlpatterns = patterns('',
    ...
    url(r"^polls/(\d+)/responses/module/$", login_required(views.view_responses),  {'as_module':True}),    
    url(r"^polls/responses/(\d+)/view/$", login_required(views.view_response)),    
    url(r"^polls/(\d+)/report/$", login_required(views.view_report)),
    url(r"^polls/(\d+)/report/(\d+)/$", login_required(views.view_report)),
    url(r"^polls/(\d+)/report/module/$", login_required(views.view_report), {'as_module':True}),
    url(r"^polls/(\d+)/report/(\d+)/module/$", login_required(views.view_report), {'as_module':True}),
    url(r"^polls/responses/(\d+)/edit/$", login_required(views.edit_response)),
    url(r"^polls/responses/(\d+)/apply/$", login_required(views.apply_response)),
    url(r"^polls/responses/(\d+)/apply_all/$", login_required(views.apply_all)),
