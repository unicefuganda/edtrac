...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmisReporter.grade'
        db.add_column('education_emisreporter', 'grade', self.gf('django.db.models.fields.CharField')(max_length=2, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmisReporter.grade'
        db.delete_column('education_emisreporter', 'grade')
