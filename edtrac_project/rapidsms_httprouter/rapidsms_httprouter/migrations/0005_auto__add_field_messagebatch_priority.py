...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageBatch.priority'
        db.add_column('rapidsms_httprouter_messagebatch', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageBatch.priority'
        db.delete_column('rapidsms_httprouter_messagebatch', 'priority')
