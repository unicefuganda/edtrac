...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.default_response'
        db.alter_column('poll_poll', 'default_response', self.gf('django.db.models.fields.CharField')(max_length=160, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Poll.default_response'
        raise RuntimeError("Cannot reverse this migration. 'Poll.default_response' and its values cannot be restored.")
    ...
    models = {
        ...
        'poll.poll': {
            ...
            'contacts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'polls'", 'symmetrical': 'False', 'to': "orm['rapidsms.Contact']"}),
