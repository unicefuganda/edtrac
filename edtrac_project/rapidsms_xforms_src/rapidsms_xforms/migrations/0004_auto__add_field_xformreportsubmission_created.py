...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XFormReportSubmission.created'
        db.add_column('rapidsms_xforms_xformreportsubmission', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'XFormReportSubmission.created'
        db.delete_column('rapidsms_xforms_xformreportsubmission', 'created')
