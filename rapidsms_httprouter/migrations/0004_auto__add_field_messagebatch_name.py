...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageBatch.name'
        db.add_column('rapidsms_httprouter_messagebatch', 'name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageBatch.name'
        db.delete_column('rapidsms_httprouter_messagebatch', 'name')
