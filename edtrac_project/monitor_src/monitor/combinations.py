## {{{ http://code.activestate.com/recipes/190465/ (r1)
#!/usr/bin/env python
...
if __name__=="__main__":
    ...
    for uc in xuniqueCombinations(['mtn-modem','orange-modem','utl-modem','warid-modem','airtel-modem'],2): print ','.join(uc)
...
## end of http://code.activestate.com/recipes/190465/ }}}
