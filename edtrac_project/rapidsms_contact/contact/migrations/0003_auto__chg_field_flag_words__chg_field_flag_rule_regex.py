...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Flag.words'
        db.alter_column('contact_flag', 'words', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Flag.rule_regex'
        db.alter_column('contact_flag', 'rule_regex', self.gf('django.db.models.fields.CharField')(max_length=700, null=True))
    def backwards(self, orm):

        # Changing field 'Flag.words'
        db.alter_column('contact_flag', 'words', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Flag.rule_regex'
        db.alter_column('contact_flag', 'rule_regex', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    models = {
        'auth.group': {
