...
#    url(r'^edtrac/reporters/connection/create/$', EdtracReporterCreateConnection.as_view(), name="new-connection"),
    ...
    url(r'^edtrac/detail-attd/$', report_dashboard, name="detail-attendance-visualization"),
    ...
    url(r'^edtrac/api/dashReport/params/(?P<start_date>w+)/(?P<end_date>w+)/(?P<indicator>w+)$',dash_report_params, name="dash_report_params"),
