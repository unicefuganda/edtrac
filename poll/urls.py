...
urlpatterns = patterns('',
    ...
    url(r"^responses/(?P<poll_id>\d+)/agestats/$", views.age_stats, name="poll-age-stats"),
    url(r"^responses/(?P<poll_id>\d+)/genderstats/(?P<gender>\d+)/$", views.gender_stats, name="poll-gender-stats"),
