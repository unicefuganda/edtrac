...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmisReporter.has_exact_matched_school'
        db.add_column('education_emisreporter', 'has_exact_matched_school',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmisReporter.has_exact_matched_school'
        db.delete_column('education_emisreporter', 'has_exact_matched_school')
