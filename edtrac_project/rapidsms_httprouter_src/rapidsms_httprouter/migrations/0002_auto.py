...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Message', fields ['status']
        db.create_index('rapidsms_httprouter_message', ['status'])

        # Adding index on 'Message', fields ['direction']
        db.create_index('rapidsms_httprouter_message', ['direction'])

        # Adding index on 'Message', fields ['priority']
        db.create_index('rapidsms_httprouter_message', ['priority'])


    def backwards(self, orm):
        
        # Removing index on 'Message', fields ['priority']
        db.delete_index('rapidsms_httprouter_message', ['priority'])

        # Removing index on 'Message', fields ['direction']
        db.delete_index('rapidsms_httprouter_message', ['direction'])

        # Removing index on 'Message', fields ['status']
        db.delete_index('rapidsms_httprouter_message', ['status'])
